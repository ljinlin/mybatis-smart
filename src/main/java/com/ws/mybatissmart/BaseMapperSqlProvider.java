...
public class BaseMapperSqlProvider {
	...
	public String selectList(Object obj, WhereSql filterSqlBuild) {
		ClassMapperInfo cmi = MybatisSmartContext.getClassMapperInfo(obj.getClass());
	...
	public String deleteById(Object idV, Class<?> cl) {
		ClassMapperInfo cmi = MybatisSmartContext.getClassMapperInfo(cl);
		String sql = cmi.getDeleteByIdSql(idV);
		return sql;
	}
